...
public class BuscarTodos extends javax.swing.JFrame {
    ...
    // Defina todas as colunas aqui (nomes das colunas)
    modelo.addColumn("ID");
    ...
    private void initComponents() {
        ...
        btnEditar.setBackground(new java.awt.Color(103, 229, 186));
        ...
        tabelaFuncionarios.setBackground(new java.awt.Color(103, 229, 186));
